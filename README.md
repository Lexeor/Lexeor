...
Frontend Developer with 4+ years of experience building modern web applications with **React**, **TypeScript**, and **JavaScript (ES6+)**.

Previously spent 12 years as IT Infrastructure Manager at Sandvik (Fortune 500), leading teams and delivering enterprise-scale projects — which gave me a strong foundation in cross-functional collaboration, Agile delivery, and systems thinking.

### What I work with

- **Core:** React 18/19, TypeScript, JavaScript (ES6+)
- **State Management:** Zustand, MobX, Redux Toolkit
...
Open to remote frontend opportunities worldwide.
